    ...
    return (
        <aside className="sidebar">
            <section className="panel panel--yellow">
                ...
                <input id="searchInput" className="search-input" type="text" placeholder="Bijv. castle, ghost, 10332..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value.toLowerCase())} />
